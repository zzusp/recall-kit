...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-sm w-full fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <nav className="md:ml-6 flex md:space-x-8">
              <Link 
                href="/" 
              ...
              <Link 
                href="/docs" 
                className={`${isActive('/docs') ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500'} hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
              >
                文档
              </Link>
              {/* 知识库功能已隐藏 */}
          ...
          <div className="md:ml-4 flex md:items-center">
